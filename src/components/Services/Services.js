...
const services = [
...

  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path d="M14 4c5 0 9 4 9 9s-4 9-9 9-9-4-9-9 4-9 9-9z" stroke="currentColor" strokeWidth="1.5"/>
        <path d="M10 14c1.5 2 5.5 2 7 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M11 11h.01M17 11h.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
    title: 'Psychiatry Sessions',
    description: 'Professional mental health support with certified psychiatrists for therapy and consultation.',
  },
  ...
  return (
    <section className={styles.services} ref={sectionRef} id="services">
      <div className={`${styles.inner} container`}>
        <div className={styles.header} id="services-header">
          <span className="section-label">Our Services</span>
          <h2 className="section-title">
            Comprehensive Healthcare Services,
            <br />Tailored to Your Environment
          </h2>
          {/* <p className="section-subtitle">
           Comprehensive healthcare services tailored to your loved ones at your doorstep
          </p> */}
        </div>
